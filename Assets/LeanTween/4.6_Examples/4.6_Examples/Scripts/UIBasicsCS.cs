...
public class UIBasicsCS : MonoBehaviour {
	...
	void Start () {
		...
		LeanTween.move( pauseWindow, pauseWindow.anchoredPosition3D + new Vector3(0f,-200f,0f), 0.6f).setEase(LeanTweenType.easeOutSine).setDelay(0.6f);
