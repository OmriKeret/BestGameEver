...
public class Punchoes {
    ...
    public List<ClothModel> pounchoes = new List<ClothModel> {
		...
		new ClothModel{id = 2, description = "Imbued with epic stuff. 'nuff said.", jemPrice = -1, name = "Black Sun Poncho", owned = false, part = BodyPart.puncho, PJPrice = 0,characterSpriteFront = "Cloth/Poncho/poncho2",characterSpriteBack = "Cloth/Poncho/poncho back", selected = false, statsImprove = new StatsImprovementModel{}}
